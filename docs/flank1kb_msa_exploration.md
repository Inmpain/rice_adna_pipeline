...
## [精确化] DTH8/Ghd8缺失簇的准确统计

按缺失长度重新聚类计数(修正了之前awk字段索引错误)，DTH8区域(chr08:4332716-
4336434)内的DEL记录分布：

- **~1116-1359bp缺失簇(经典功能丧失型)**：163/3024份材料(约5.4%)，含多个
  断点坐标略有抖动的版本(1116/1117/1224/1359/1254/1219/1218/1214/1211/
  1210/1207/1160/1152bp)，判定为同一生物学事件，断点抖动源于该区域的
  微同源性/低复杂度序列特征
- 12bp缺失(chr08:4333585-4333597)：107份材料，独立的背景小indel，非causal
- 19bp缺失(chr08:4334626-4334645)：15份材料，独立背景小indel，位于缺失簇外
- 其余(49bp/14bp)：各仅2份，样本量过小无意义

5.4%这个频率水平符合"特定亚群富集但非群体主流"的典型功能变异分布特征，
与文献报道的DTH8经典大片段缺失型高度吻合，是三个优先基因里目前证据最扎实
的候选断点，已存档供未来更深数据验证使用。
